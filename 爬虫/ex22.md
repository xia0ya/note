...
本练习演示如何针对网站利用CSS伪元素（::before、::after）混淆数字的反爬机制，建立映射表还原真实数据。

---

```python
# coding=utf-8
# 功能：破解CSS伪元素反爬，建立映射表还原真实数字
...
base_url = 'https://spiderbuf.cn/web-scraping-practice/css-pseudo-elements'
...
if __name__ == '__main__':
    html = getHTML(base_url, './n04.html')
    parseHTML(html)
```
...
## 说明
- 该代码演示了如何针对CSS伪元素反爬机制，建立映射表还原真实数字。
